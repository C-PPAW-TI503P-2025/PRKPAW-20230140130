...
function DashboardPage() {
  ...
  useEffect(() => {
    ...
    if (token) {
      try {
        ...
        // Simulasi data cuaca (bisa diganti dengan API real)
        const fakeWeather = {
  ...
  const handleLogout = () => {
    localStorage.removeItem('token'); // 1. Menghapus token dari local storage
    navigate('/login'); //2. Mengarahkan kembali ke halaman login
  };
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <button className="flex flex-col items-center justify-center p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition duration-200">
            ...
            <button className="flex flex-col items-center justify-center p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-green-500 hover:bg-green-50 transition duration-200">
              <svg className="w-8 h-8 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">

...
![PUT](TUGAS/Screenshots/Update_Data_Presensi.png)

### 2. PUT (Endpoint Update Jika Format Tanggal yang Diisi Valid)
![PUT](TUGAS/Screenshots/Update_Format_Tanggal_Valid.png)

### 3. PUT (Endpoint Update Jika Format Tanggal yang Diisi Tidak Valid)
![PUT](TUGAS/Screenshots/Update_Format_Tanggal_Tidak_Valid.png)

### 4. DELETE (Endpoint Delete Data)
![DELETE](TUGAS/Screenshots/Delete_Data.png)

### 5. GET (Enpoint Search Berdasarkan Nama)
![GET](TUGAS/Screenshots/Search_Berdasarkan_Nama.png)

### 6. GET (Endpoint Search Berdasarkan Tanggal)
![GET](TUGAS/Screenshots/Search_Berdasarkan_Tanggal.png)